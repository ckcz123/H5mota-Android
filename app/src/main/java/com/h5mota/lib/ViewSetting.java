...
public class ViewSetting {
  ...
  public static void setEditTextValue(
      final Object father, final int resourceid, final String string) {
    try {
      if (father == null || resourceid == 0) return;
      EditText editText = null;
      if (father instanceof Activity)
  ...
  public static void setOnClickListener(
      final Object father, final int resourceid, final View.OnClickListener onClickListener) {
    try {
      if (father == null || resourceid == 0) return;
      View view = null;
      if (father instanceof Activity) view = ((Activity) father).findViewById(resourceid);
      else if (father instanceof View) view = ((View) father).findViewById(resourceid);
      else if (father instanceof Dialog) view = ((Dialog) father).findViewById(resourceid);
      if (view == null) return;
  ...
  public static void setImageDrawable(
      final Object father, final int resourceid, final Drawable drawable) {
    try {
      if (father == null || resourceid == 0) return;
  ...
  public static void setImageBitmap(
      final Object father, final int resourceid, final Bitmap bitmap) {
    try {
      if (father == null || resourceid == 0) return;
      ImageView imageView = null;
      if (father instanceof Activity)
  ...
  public static void setSwitchChecked(
      final Object father, final int resourceid, final boolean checked) {
    try {
      if (father == null || resourceid == 0) return;
      Switch switch1 = null;
      if (father instanceof Activity)
        switch1 = (Switch) ((Activity) father).findViewById(resourceid);
      else if (father instanceof View) switch1 = (Switch) ((View) father).findViewById(resourceid);
      else if (father instanceof Dialog)
  ...
  public static void setSwitchOnCheckChangeListener(
      final Object father,
  ...
  public static void setBackground(
      Context context, View view, Bitmap bitmap, int width, int height) {
    ...
    try {
      ...
      view.setBackgroundDrawable(new BitmapDrawable(context.getResources(), ans));
    } catch (Exception e) {
    } catch (OutOfMemoryError e) {
      System.gc();
    }
  ...
  public static void setBackground(
      Context context, View view, Drawable drawable, int width, int height) {
    if (width == 0 || height == 0 || view == null || drawable == null) return;
    setBackground(context, view, ((BitmapDrawable) drawable).getBitmap(), width, height);
  }
  ...
  public static void setBackground(Context context, View view, int resid, int width, int height) {
    try {
      if (view == null || resid == 0) return;
      Drawable drawable = context.getResources().getDrawable(resid);
      if (drawable == null) return;
