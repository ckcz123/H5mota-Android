...
public class MyNotification {
  public static void sendNotification(
      String title, String content, String ticker, Context context, String type, Class<?> cls) {
  ...
  public static void sendNotificationToOpenfile(
      String title, String content, String ticker, Context context, File file) {
    if (Build.VERSION.SDK_INT < 16) return;
    ...
    PendingIntent pendingIntent =
        PendingIntent.getActivity(
            context, new Random().nextInt(), intent, PendingIntent.FLAG_UPDATE_CURRENT);
    builder.setContentIntent(pendingIntent);
    NotificationManager notificationManager =
        (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
