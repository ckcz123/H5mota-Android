...
/**
 * A simple text label view that can be applied as a "badge" to any given {@link View}. This class
 * is intended to be instantiated at runtime rather than included in XML layouts.
 *
 * @author Jeff Gilfelt
 */
public class BadgeView extends AppCompatTextView {
   ...
   * Constructor -
   *
   * <p>create a new BadgeView instance attached to a target {@link View}.
   *
   ...
   * Constructor -
   *
   * <p>create a new BadgeView instance attached to a target {@link TabWidget} tab at a given index.
   *
   * @param context context for this view.
  ...
  public void setScale(float scale) {
    this.scale = scale;
    setTextSize(TypedValue.COMPLEX_UNIT_SP, Utils.px2sp(context, (int) getTextSize()) * scale);
  }
   ...
   * value, its label will be set to "0".
   *
   ...
   *
   * <p>one of POSITION_TOP_LEFT, POSITION_TOP_RIGHT, POSITION_BOTTOM_LEFT, POSITION_BOTTOM_RIGHT.
   */
  ...
  public static void show(Context context, View view, String text, int margin, float scale) {
    if (context == null || view == null) return;
    if (text == null) text = "";
    BadgeView badgeView = hashMap.get(context.hashCode() + view.hashCode());
    if (badgeView != null) badgeView.resetScale();
    else badgeView = new BadgeView(context, view);
